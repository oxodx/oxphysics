package nl.oxod.oxphysics.api.math;
...
public class QuaternionHelper {
  /**
   * Rotate the given {@link Quaternionf} by the given number of degrees on the X
   * axis.
   * 
  ...
  /**
   * Rotate the given {@link Quaternionf} by the given number of degrees on the Y
   * axis.
   * 
   * @param quat the {@link Quaternionf} to perform the operation on
   * @param deg  number of degrees to rotate by
  ...
  /**
   * Rotate the given {@link Quaternionf} by the given number of degrees on the Z
   * axis.
   * 
   * @param quat the {@link Quaternionf} to perform the operation on
   * @param deg  number of degrees to rotate by
  ...
  public static Quaternionf fromTag(CompoundTag tag) {
    return new Quaternionf(tag.getFloatOr("i", 0), tag.getFloatOr("j", 0), tag.getFloatOr("k", 0),
        tag.getFloatOr("r", 0));
  }
